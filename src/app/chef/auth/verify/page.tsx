    ...
    if (!isLoading) {
      if (isAuthenticated && user) {
        ...
        if (signUpForceRedirectUrl) {
          const url = new URL(signUpForceRedirectUrl)
        ...
        if (clerkStatus === 'client_mismatch') {
          // Redirect back to auth page for re-authentication
      ...
      <div className="max-w-md mx-auto pt-16 pb-20 px-4 relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            We&apos;re processing your email verification. Please wait a moment.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Your email verification is being processed. You&apos;ll be redirected automatically once complete.
            </p>
