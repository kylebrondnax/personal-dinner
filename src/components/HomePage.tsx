        ...
        <div className='max-w-7xl mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-theme-card p-8 rounded-2xl shadow-lg border border-theme-primary'>
              ...
              <h3 className='text-2xl font-bold text-theme-primary mb-4'>For Guests</h3>
            ...
            <div className='bg-theme-card p-8 rounded-2xl shadow-lg border border-theme-primary'>
              <div className='text-4xl mb-6'>👨‍🍳</div>
              <h3 className='text-2xl font-bold text-theme-primary mb-4'>For Hosts</h3>
              <ul className='text-theme-muted space-y-3'>
                <li className='flex items-start'>
                  <span className='text-green-500 mr-2'>✓</span>
            ...
            <div className='bg-theme-card p-8 rounded-2xl shadow-lg border border-theme-primary'>
              ...
              <h3 className='text-2xl font-bold text-theme-primary mb-4'>For Everyone</h3>
              <ul className='text-theme-muted space-y-3'>
                <li className='flex items-start'>
                  <span className='text-green-500 mr-2'>✓</span>
